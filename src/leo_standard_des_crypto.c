...
void IP(unsigned int state[], const unsigned char in[])
{
...
unsigned int f(unsigned int state, const unsigned char key[])
{
...
void des_key_setup(const unsigned char key[], unsigned char schedule[][6], DES_MODE mode)
{
  ...
  const unsigned int key_perm_c[28] = {
    56, 48, 40, 32, 24, 16, 8,
    0,  57, 49, 41, 33, 25, 17,
    9,  1,  58, 50, 42, 34, 26,
    18, 10, 2,  59, 51, 43, 35,
  };
  const unsigned int key_perm_d[28] = {
